        ...
        return(
            <div>
                <div className="paginationDiv">
                    <a className={this.props.current == 1? 'prev disable' : 'prev'} onClick={this.props.goPre.bind(this)}></a>
                    <span>
                        {
                    ...
                    <div className="rightDiv">
                        totalItems <span className="num-total">{_this.props.total}</span>&nbsp;&nbsp;
                        totalPages <span className="num-total">{_this.props.totalPage}</span>&nbsp;&nbsp;
                          turnto Page
